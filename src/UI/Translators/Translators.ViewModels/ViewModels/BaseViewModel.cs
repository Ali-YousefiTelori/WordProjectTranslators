...
namespace Translators.ViewModels
{
    public class BaseViewModel : BaseModel
    {
        ...
        {
            return text.Replace("ۛ", "").Replace("ۖ", "").Replace("ۗ", "").Replace("ۚ", "").Replace("ۙ", "").Replace("ۘ", "").Replace("ۜ", "").Replace("ِ", "").Replace("ُ", "").Replace("َ", "").Replace("ً", "").Replace("ٌ", "").Replace("ٍ", "").Replace("ّ", "");
        }
