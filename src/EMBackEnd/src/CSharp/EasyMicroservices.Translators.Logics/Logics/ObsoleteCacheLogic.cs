...
{
    public class ObsoleteCacheLogic : IHostedService
    {
        IServiceProvider _serviceProvider;
        public ObsoleteCacheLogic(IServiceProvider serviceProvider)
        {
        ...
        async Task Initialize()
        {
            ...
            using var context2 = _serviceProvider.GetService<TranslatorContext>();
        ...
        public void FixPageBookIds(List<PageContract> pageContracts)
        {
